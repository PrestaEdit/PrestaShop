...
class PHP_CodeSniffer
{
    ...
    public static function autoload($className)
    {
        ...
        } else if (is_file(dirname(__FILE__).'/Standards/'.$path) === true) {
            // Check for included sniffs.
            include dirname(__FILE__).'/Standards/'.$path;
    ...
    public function setTokenListeners($standard, array $sniffs=array())
    {
        if (is_dir($standard) === true) {
            ...
            self::$standardDir = realpath(dirname(__FILE__).'/Standards/'.$standard);
