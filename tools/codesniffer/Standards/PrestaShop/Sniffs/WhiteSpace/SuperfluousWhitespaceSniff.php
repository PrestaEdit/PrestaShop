 ...
 * @version   CVS: $Id: SuperfluousWhitespaceSniff.php 8456 2011-09-09 15:56:52Z rMalie $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Prestashop_Sniffs_WhiteSpace_SuperfluousWhitespaceSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === T_OPEN_TAG) {
            ...
            */
            ...
            $phpcsFile->addWarning('Additional whitespace found at start of file', $stackPtr, 'StartFile');
            ...
            */
            ...
            $phpcsFile->addWarning('Additional whitespace found at end of file', $stackPtr, 'EndFile');
            ...
            */
            ...
            if (empty($tokenContent) === false) {
                if (preg_match('|^.*\s+$|', $tokenContent) !== 0) {
                    $phpcsFile->addWarning('Whitespace found at end of line', $stackPtr, 'EndLine');
                }
            }
            ...
            if ($phpcsFile->hasCondition($stackPtr, T_FUNCTION) === true) {
                if ($tokens[($stackPtr - 1)]['line'] < $tokens[$stackPtr]['line'] && $tokens[($stackPtr - 2)]['line'] === $tokens[($stackPtr - 1)]['line']) {
                    ...
                    if ($lines > 1) {
                        ...
                        $data  = array($lines);
                        $phpcsFile->addWarning($error, $stackPtr, 'EmptyLines', $data);
                    }
                }
            }
